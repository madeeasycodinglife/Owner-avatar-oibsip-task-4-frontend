...
import ExamHistoriesComponent from "../exam/ExamHistoriesComponent";
    ...
    <div className="max-w-full min-h-screen font-serif font-bold mx-auto bg-gradient-to-r from-blue-600 to-blue-400 text-white">
      ...
      {/* <div id="profile" className="min-h-[10.125rem]">
        <div className="flex items-center justify-between">
          <div className="flex gap-11">
            <FaUserCircle className="text-8xl text-green-900 ml-24 mt-8" />
            <div className="text-2xl font-serif font-semibold flex flex-col gap-2 pt-4">
              <div className="flex items-center  gap-2">
                <FaUser className="text-xl text-green-900 mt-1" />
                <p className="flex gap-2">
                  {foundUser?.fullName || "No user found"}
                </p>
              </div>
              <div className="flex items-center justify-center gap-2 -ms-28">
                <div>
                  <FaPhone className="text-xl text-green-900 mt-1 " />
                </div>
                <p className="flex gap-2">+91 {foundUser?.phone || "N/A"}</p>
              </div>
              <div className="flex items-center gap-2 justify-center">
                <FaEnvelope className="text-xl text-green-900 mt-2" />
                <p>{foundUser?.email || "N/A"}</p>
              </div>
            </div>
          </div>
          <div className="text-xl mr-4 bg-gradient-to-r from-purple-600 to-purple-400 text-white p-4 rounded-lg animate-pulse">
      ...
      <div id="profile" className="min-h-[10.125rem]">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-8 ml-32">
            <FaUserCircle className="text-8xl text-green-900 mt-8" />
      ...
      >
        <div className="flex flex-col shadow-lg w-1/4">
          <ul className="flex flex-col gap-y-9 text-2xl ml-6 mt-4">
            <li
            ...
            <li
              className="flex items-center gap-2 hover:cursor-pointer"
              onClick={() => setSelectedComponent("examHistories")}
            >
              <FaClipboardList className="text-2xl text-green-900" />
              <span>Exam Histories</span>
            </li>
            <li
              className="flex items-center gap-2 hover:cursor-pointer"
